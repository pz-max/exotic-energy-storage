...
def load_costs(Nyears=1., tech_costs=None, config=None, elec_config=None):
    ...
    costs.loc["battery-low-LCOS"] = \
        costs_for_storage(costs.loc["battery storage-low-LCOS"], costs.loc["battery inverter-low-LCOS"],
                          max_hours=max_hours['battery-low-LCOS'])

    costs.loc["battery-high-LCOS"] = \
        costs_for_storage(costs.loc["battery storage-high-LCOS"], costs.loc["battery inverter-high-LCOS"],
                          max_hours=max_hours['battery-high-LCOS'])

    costs.loc["H2"] = \
        costs_for_storage(costs.loc["hydrogen storage"], costs.loc["fuel cell"],
                          costs.loc["electrolysis"], max_hours=max_hours['H2'])

    costs.loc["H2-low-LCOS"] = \
        costs_for_storage(costs.loc["hydrogen storage"], costs.loc["fuel cell-low-LCOS"],
                          costs.loc["electrolysis-low-LCOS"], max_hours=max_hours['H2-low-LCOS'])

    costs.loc["H2-high-LCOS"] = \
        costs_for_storage(costs.loc["hydrogen storage"], costs.loc["fuel cell-high-LCOS"],
                          costs.loc["electrolysis-high-LCOS"], max_hours=max_hours['H2-high-LCOS'])
