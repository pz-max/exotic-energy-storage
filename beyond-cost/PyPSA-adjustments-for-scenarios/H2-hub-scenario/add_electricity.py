...
##################
    # The section below is for 'storage unit' definition.
    # It combines the cost components from the costs.csv (input) and the max_hours config.yaml (input)
    # to create the 'storage unit' costs (output).
    # The 'storage unit' by itself is indexed/and created in the config.yaml file.
##################
    costs.loc["battery"] = \
