...
def attach_stores(n, costs):
    ...
    if 'H2-scenario-h-LCOS' in carriers:
        h2_buses_i = n.madd("Bus", buses_i + " H2-scenario-h-LCOS", carrier="H2-scenario-h-LCOS", **bus_sub_dict)
        ...
        n.madd("Link", h2_buses_i + " Electrolysis-high-LCOS",
               bus0=buses_i,
               bus1=h2_buses_i,
               carrier='H2 electrolysis-high-LCOS',
               p_nom_extendable=True,
               efficiency=costs.at["electrolysis-high-LCOS", "efficiency"],
               capital_cost=costs.at["electrolysis-high-LCOS", "capital_cost"])

        n.madd("Link", h2_buses_i + " Fuel Cell-high-LCOS",
               bus0=h2_buses_i,
               bus1=buses_i,
               carrier='H2 fuel cell-high-LCOS',
               p_nom_extendable=True,
               efficiency=costs.at["fuel cell-high-LCOS", "efficiency"],
               #NB: fixed cost is per MWel
               capital_cost=costs.at["fuel cell-high-LCOS", "capital_cost"] * costs.at["fuel cell-high-LCOS", "efficiency"])
        

    if 'H2-scenario-l-LCOS' in carriers:
        h2_buses_i = n.madd("Bus", buses_i + " H2-scenario-l-LCOS", carrier="H2-scenario-l-LCOS", **bus_sub_dict)
        ...
        n.madd("Link", h2_buses_i + " Electrolysis-low-LCOS",
               bus0=buses_i,
               bus1=h2_buses_i,
               carrier='H2 electrolysis-low-LCOS',
               p_nom_extendable=True,
               efficiency=costs.at["electrolysis-low-LCOS", "efficiency"],
               capital_cost=costs.at["electrolysis-low-LCOS", "capital_cost"])        
        
        n.madd("Link", h2_buses_i + " Fuel Cell-low-LCOS",
               bus0=h2_buses_i,
               bus1=buses_i,
               carrier='H2 fuel cell-low-LCOS',
               p_nom_extendable=True,
               efficiency=costs.at["fuel cell-low-LCOS", "efficiency"],
               #NB: fixed cost is per MWel
               capital_cost=costs.at["fuel cell-low-LCOS", "capital_cost"] * costs.at["fuel cell-low-LCOS", "efficiency"])       
